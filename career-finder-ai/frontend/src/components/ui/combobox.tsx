...
/** Opens the combobox popup — same as Trigger but without the default chevron (custom icon buttons). */
function ComboboxIconTrigger({
  className,
  children,
  ...props
}: ComboboxPrimitive.Trigger.Props) {
  return (
    <ComboboxPrimitive.Trigger
      data-slot="combobox-icon-trigger"
